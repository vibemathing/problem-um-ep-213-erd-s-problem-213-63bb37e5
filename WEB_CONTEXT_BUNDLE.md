...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-213-erd-s-problem-213-63bb37e5-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-213"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-213-erd-s-problem-213-63bb37e5-v1",
      "problem_contract_sha256": "be069835441f3aed81266180a67b3fb48383b223a5b2d839dfd273a1a21d034b",
      "problem_id": "problem:um-ep-213-erd-s-problem-213-63bb37e5",
      "route_id": "route:um-ep-213-erd-s-problem-213-63bb37e5-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-213-erd-s-problem-213-63bb37e5-source-fidelity-01",
      "graph_id": "graph:um-ep-213-erd-s-problem-213-63bb37e5-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-213-erd-s-problem-213-63bb37e5-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-213-erd-s-problem-213-63bb37e5-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $n\\geq 4$. Are there $n$ points in $\\mathbb{R}^2$, no three on a line and no four on a circle, such that all pairwise distances are integers?"
          },
          "statement_sha256": "f7e4996c3641e3cd44ac6d110b407705313592901d7fef4d06be8d6a061a1867"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-213-erd-s-problem-213-63bb37e5-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-213-erd-s-problem-213-63bb37e5-root",
      "route_id": "route:um-ep-213-erd-s-problem-213-63bb37e5-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-213-cc4b75b02502",
        "url": "https://www.unsolvedmath.com/problems/EP-213"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
